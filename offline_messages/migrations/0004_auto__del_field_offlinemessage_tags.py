...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OfflineMessage.tags'
        db.add_column('offline_messages_offlinemessage', 'tags', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
